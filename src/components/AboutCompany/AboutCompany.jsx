          ...
          <div className="row aboutRow">
            <div className="col-lg-6 col-md-6 col-sm-12 mx-auto my-2">
              ...
              <p className="aboutText">
                ...
                optimallashtirish, kontent yaratish va reklama kampaniyalarini
                o'z ichiga olgan keng ko'lamli xizmatlarni taklif etamiz. Biz
                eng yangi texnologiyalar va innovatsion usullardan foydalangan
                holda brendni rivojlantirish va sotishni ko'paytirish bilan
                shug'ullanamiz.
              </p>
            </div>
